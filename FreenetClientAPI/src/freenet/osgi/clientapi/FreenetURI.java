...
package freenet.osgi.clientapi;
...
import freenet.log.LogThresholdCallback;
import freenet.log.Logger;
import freenet.osgi.support.Base64;
import freenet.osgi.support.Fields;
import freenet.osgi.support.HexUtil;
import freenet.osgi.support.IllegalBase64Exception;
import freenet.osgi.support.URLDecoder;
import freenet.osgi.support.URLEncodedFormatException;
...
//		this.uniqueHashCode = super.hashCode();
	...
	public static FreenetURI readFullBinaryKey(DataInputStream dis) throws IOException {
		...
		if((type == CHK) || (type == SSK)) {
			...
			int extraLen;
			extraLen = (type == CHK ? Constants.CLIENT_CHK_EXTRA_LENGTH : Constants.CLIENT_SSK_EXTRA_LENGTH);
